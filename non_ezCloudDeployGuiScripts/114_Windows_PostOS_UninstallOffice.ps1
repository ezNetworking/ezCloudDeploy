<#
.SYNOPSIS
This script downloads and runs the Office Removal Tool to remove Microsoft Office applications. 

.DESCRIPTION
This code downloads the Office Removal Tool from a URL, unzips it, and runs it with certain arguments. It checks if the script is running as an administrator and if the specified download path exists. It also deletes any existing folder at a specified path.

.PARAMETER $SaraScenarioArgument
...
Version: 0.2 | MS Version: 17.12.09.2022
...
$resultsFileName = "ezRMM_SaRaResults_$currentTimeStamp.zip"
$currentLocation = "C:\ezNetworking\Automation\Apps"
$resultsFilePath = "$LocalLogFolder\$resultsFileName"
$SaraCmdExecutableFolder = "$currentLocation\OfficeSaRaCmd"
$SaraCmdExecutablePath = "$SaraCmdExecutableFolder\SaraCMD.exe"
$LocalLogFolder = "c:\ezNetworking\Automation\logs"
$scriptLogFile = "$LocalLogFolder\ezRMM_SaRaCmd-$currentTimeStamp.txt"
